        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_notification",
                    models.AutoField(
                        db_column="id_notification", primary_key=True, serialize=False
                    ),
                ),
                (
                    "message",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["id_utilisateur", "lue", "date_envoi"],
                        name="notificatio_id_util_7c5af1_idx",
                    ),
                    models.Index(
                        fields=["type", "date_envoi"],
                        name="notificatio_type_9f2480_idx",
                    ),
                ],
            },
        ),
