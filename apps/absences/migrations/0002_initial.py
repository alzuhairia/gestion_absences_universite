...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="absence",
            index=models.Index(
                fields=["id_inscription", "statut"], name="absence_id_insc_9eba9f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="absence",
            index=models.Index(
                fields=["id_seance", "statut"], name="absence_id_sean_f7ddea_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="absence",
            index=models.Index(
                fields=["statut", "type_absence"], name="absence_statut_bd12b0_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="justification",
            index=models.Index(
                fields=["state", "date_validation"], name="justificati_state_acfe9b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="justification",
            index=models.Index(
                fields=["validee_par", "state"], name="justificati_validee_fcba00_idx"
            ),
        ),
    ]
