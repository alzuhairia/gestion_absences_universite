        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id_log",
                    models.AutoField(
                        db_column="id_log", primary_key=True, serialize=False
                    ),
                ),
                (
                    "action",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["date_action", "niveau"],
                        name="log_audit_date_ac_6a5547_idx",
                    ),
                    models.Index(
                        fields=["objet_type", "objet_id"],
                        name="log_audit_objet_t_c41e87_idx",
                    ),
                    models.Index(
                        fields=["id_utilisateur", "date_action"],
                        name="log_audit_id_util_63b128_idx",
                    ),
                    models.Index(
                        fields=["niveau", "date_action"],
                        name="log_audit_niveau_b3dc05_idx",
                    ),
                ],
            },
        ),
